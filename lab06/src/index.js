...
root.render(
  <React.StrictMode>
    ...
    <div id="content-2">
      <Reviews
        name="Jasmine"
        img_src="https://xsgames.co/randomusers/assets/avatars/female/39.jpg"
        quote="After a day of adventuring I was looking for a coffee spot and he wanted something to eat so I started looking for a brewery and I found this gem that is coffee and beer! I wish we lived closer because this hit the spot on every level today. We split the bacon ranch pizza and spin-aru salad, both excellent choices. After a bit we were still a little hungry so went for the cinnamon roll and pecan affogato and it was the perfect way to end a perfect day."
        date="September 1, 2022"
      />
      <Reviews
        name="Alex"
        img_src="https://xsgames.co/randomusers/assets/avatars/male/55.jpg"
        quote="My teen daughter wanted to take me out for Mothers Day. I had been wanting to try this place. I love it! Laid back atmosphere, friendly staff, great food and the place is spotless! Nice outdoor sitting area. I’m bummed we missed the live music. My teen loved it too and can’t wait to go back. It’s worth the drive 20 min from south Chandler!"
        date="June 21, 2021"
      />
      <div className="clear-float"></div>
      <Reviews
        name="Melodie"
        img_src="https://xsgames.co/randomusers/assets/avatars/female/25.jpg"
        quote="One of my favorite local breweries! You can't go wrong with anything on tap, including the root beer! The pretzel and cheese is a must every time I go. This place has the perfect set up for those days you want to work different the staff is always super helpful and great conversation. I highly recommend."
        date="March 6, 2023"
      />
      <Reviews
        name="Qaisar"
        img_src="https://xsgames.co/randomusers/assets/avatars/male/71.jpg"
        quote="Four Silos has been the best addition to our side of town! Its family friendly and a great hang out for Friday nights or Sunday breakfast! Food is great, service is fast and the staff is superb! We always feel so welcome and it is becoming a weekly hang out spot for our neighborhood families!"
        date="August 12, 2019"
      />
      <div className="clear-float"></div>
    </div>
